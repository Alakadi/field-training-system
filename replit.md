...
## Recent Changes
- June 25, 2025: تحسين صفحة إدراج الدرجات للمشرف وإصلاح مشاكل إنشاء المشرفين
  - تحديث صفحة إدراج الدرجات لتشمل زر حفظ واحد لجميع الدرجات بدلاً من أزرار منفصلة
  - إضافة مؤشر للتغييرات غير المحفوظة مع تنبيه بصري
  - إنشاء API endpoint جديد (/api/students/grades/bulk) للحفظ الجماعي للدرجات
  - إصلاح مشكلة عدم حفظ التعديلات في الدرجات
  - تحسين واجهة المستخدم لتوضيح الدرجة الحالية مقابل الدرجة الجديدة المُدخلة
