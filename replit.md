...
## Recent Changes
- July 26, 2025: إنشاء قاعدة البيانات والجداول بنجاح مع البيانات الأساسية
  - إنشاء قاعدة بيانات PostgreSQL وجميع الجداول المطلوبة للنظام (12 جدول)
  - إضافة مستخدم المسؤول (admin/admin123) مع كلمة مرور مشفرة
  - إضافة الكليات الأساسية: الهندسة والتقنية، العلوم الطبية، الإدارة والأعمال
  - إضافة 6 تخصصات موزعة على الكليات: تقنية المعلومات، الهندسة المدنية، التمريض، الصيدلة، إدارة الأعمال، المحاسبة
  - إضافة 6 مستويات دراسية من التحضيري إلى المستوى الخامس
  - إضافة السنة الدراسية الحالية 2024/2025
  - إضافة 5 مواقع تدريب: مستشفى الملك فهد، أرامكو، مستشفى الملك فيصل، البنك الأهلي، مصرف الراجحي
  - تشغيل التطبيق بنجاح والتأكد من عمل جميع الجداول
...
- July 25, 2025: إنشاء قاعدة البيانات وإعداد تشفير كلمات المرور الآمن + تحديث الاستعلامات للمنطق الجديد
  ...
  - إضافة البيانات الأساسية: الكليات، المستويات التعليمية، السنة الأكاديمية
