...
## Recent Changes
- July 18, 2025: إصلاح مشكلة تداخل درجات الطلاب بين المجموعات المختلفة
  - إضافة useEffect لمسح حالة الدرجات عند تغيير الدورة التدريبية
  - منع ظهور درجات الطلاب من مجموعة واحدة في مجموعات أخرى
  - عزل حالة الدرجات لكل مجموعة بشكل منفصل
  - إصلاح مشكلة استمرار ظهور الدرجات المدخلة في صناديق النص لجميع المجموعات
