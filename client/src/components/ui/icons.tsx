...
export const LogOut: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BarChart: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Trophy: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  ...
  >
    ...
    <path d="M4 22h16"/>
    <path d="M10 14.66V17c0 .55.47.98.97 1.21C12.04 18.75 13 20.22 13 22"/>
    <path d="M14 14.66V17c0 .55-.47.98-.97 1.21C11.96 18.75 11 20.22 11 22"/>
...
export const PanelLeft: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CheckAll: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
