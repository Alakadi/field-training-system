          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-xs text-neutral-500 mt-4 space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>يجب أن يحتوي على عمود "الرقم الجامعي" (مطلوب - 4 أرقام على الأقل)</li>
                <li>يجب أن يحتوي على عمود "اسم الطالب" أو "الاسم" (مطلوب - اسم رباعي)</li>
                ...
                <li>عمود "البريد الإلكتروني" (اختياري - يجب أن يكون صالح)</li>
                <li>عمود "رقم الهاتف" (اختياري - 9 أرقام يبدأ بـ 73/77/78/71/70)</li>
              </ul>
              <div className="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded text-yellow-800">
                <p className="font-medium text-sm">شروط مهمة:</p>
                <ul className="list-disc list-inside text-xs mt-1 space-y-1">
                  <li>الاسم يجب أن يحتوي على 4 أسماء على الأقل</li>
                  <li>لا يمكن تكرار الرقم الجامعي أو البريد الإلكتروني أو رقم الهاتف</li>
                  <li>إذا كان الطالب موجوداً، سيتم تحديث المستوى فقط عند الحاجة</li>
                </ul>
              </div>
            </div>
          </div>
